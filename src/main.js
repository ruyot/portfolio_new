...
document.querySelector('#app').innerHTML = `
  <main class="h-screen w-screen flex items-center justify-between px-8 md:px-16 lg:px-24 overflow-hidden relative">
    ...
    <div class="social-icons">
      ...
      <a href="https://linkedin.com/in/yourusername" target="_blank" rel="noopener noreferrer" class="social-icon">
        <pre class="social-logo">${linkedinLogo}</pre>
      </a>
      <a href="mailto:your.email@example.com" class="social-icon">
        <pre class="social-logo">${mailLogo}</pre>
      </a>
    </div>
